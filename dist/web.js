...
function _(t, e, r) {
  (h = N), ((t = $(t, e, !1, u)).user = !0), m ? m.push(t) : R(t);
}
function C(t, e, r) {
  return (
    (r = r ? Object.assign({}, c, r) : c),
    ((t = $(t, e, !0, 0)).observers = null),
    ...
    return new Proxy(
      {
        ...
        has(e) {
          for (let r = t.length - 1; 0 <= r; r--) if (e in H(t[r])) return !0;
          return !1;
        },
        keys() {
          var e = [];
...
const _t = (t) => null == t,
  ...
  Ot = (t) => {
    ...
    return (
      ((s = $t()).$$input = (t) => e.onInput(t.currentTarget.value)),
        ...
        k(
          (r) => {
            var s =
                ...
                (qt() ? "w-6 h-6 text-sm" : "w-10 h-10 text-xl"),
              n =
                "absolute top-0 left-0 " +
                (qt() ? " w-6 h-6 text-sm" : "w-full h-full text-xl");
            return (
              s !== r._v$ && it(t, (r._v$ = s)),
              n !== r._v$2 && ot(e, "class", (r._v$2 = n)),
              r
...
const ce = st(
  ...
  we =
    (nt(["click"]),
    st(
      '<span>Powered by<a href="https://eflowai.com" target="_blank" rel="noopener noreferrer" class="lite-badge" id="lite-badge"><span> eFlowai'
    )),
  ve = "#303235",
  xe = (t) => {
    let e, r;
    ...
    transform(t, e) {
      !(function (t, e) {
        Se && t.data instanceof Blob
          ? t.data.arrayBuffer().then(Re).then(e)
          : Ae && (t.data instanceof ArrayBuffer || Ee(t.data))
          ? e(Re(t.data))
          : Te(t, !1, (t) => {
              ($e = $e || new TextEncoder()), e($e.encode(t));
            });
      })(t, (r) => {
        var s,
          n = r.length;
...
const We = Ge.setTimeout,
  Ve = Ge.clearTimeout;
function Ye(t, e) {
  e.useNativeTimers
    ? ((t.setTimeoutFn = We.bind(Ge)), (t.clearTimeoutFn = Ve.bind(Ge)))
        ...
        "function" == typeof WebTransport &&
          ...
          this.transport.ready.then(() => {
            this.transport.createBidirectionalStream().then((t) => {
                  ...
                  transform(i, a) {
                    for (r.push(i); ; ) {
                      if (0 === s) {
                        ...
                        if (De(r) < n) break;
                        (h = Fe(r, n)),
                          a.enqueue(Ne(o ? h : Ie.decode(h), e)),
                          (s = 0);
                      }
                      if (0 === n || n > t) {
                        a.enqueue(Ce);
              ...
              (e = qe()).readable.pipeTo(t.writable),
...
function Tr(t) {
  var e = [],
    r = t.data;
  return (
    (t.data = Pr(r, e)), (t.attachments = e.length), { packet: t, buffers: e }
  );
}
function Pr(t, e) {
  if (!t) return t;
  ...
  if (Array.isArray(t)) {
    ...
    for (let r = 0; r < t.length; r++) s[r] = Pr(t[r], e);
    return s;
  }
  if ("object" != typeof t || t instanceof Date) return t;
  var n = {};
  for (const r in t)
    Object.prototype.hasOwnProperty.call(t, r) && (n[r] = Pr(t[r], e));
  return n;
}
function Rr(t, e) {
...
function $r(t, e) {
  if (t) {
    ...
    if (Array.isArray(t)) for (let r = 0; r < t.length; r++) t[r] = $r(t[r], e);
  ...
  takeBinaryData(t) {
    return (
      ...
      this.buffers.length === this.reconPack.attachments
        ? ((t = Rr(this.reconPack, this.buffers)),
...
(Ir.prototype.duration = function () {
  var t,
    e,
  ...
  (Ir.prototype.setMin = function (t) {
    this.ms = t;
  }),
  (Ir.prototype.setMax = function (t) {
    this.max = t;
  }),
  (Ir.prototype.setJitter = function (t) {
    this.jitter = t;
  });
class Dr extends Ue {
  constructor(t, e) {
  ...
  socket(t, e) {
    ...
    return (
      r
        ...
        : ((r = new qr(this, t, e)), (this.nsps[t] = r)),
      r
    );
  }
  _destroy(t) {
...
Object.assign(Ur, { Manager: Dr, Socket: qr, io: Ur, connect: Ur });
const Gr = st("<style>"),
  Hr = st(
...
const Vr = (t) => {
  ...
  Xr = st("<div>"),
  Jr = st('<div class="w-full h-32">'),
  Kr = "Hi there! How can I help?",
  Qr = (t) => {
    let e, r, s;
    const [n, o] = x(""),
      [i, a] = x(!1),
      [l, c] = x(!1),
      [h, u] = x({}),
      [p, d] = x([{ message: t.welcomeMessage ?? Kr, type: "apiMessage" }], {
        equals: !1,
      }),
      [f, g] = x(""),
      [b, y] = x(!1),
        ...
        _(async () => {
          ...
          return (
            ...
            () => {
              o(""),
                a(!1),
                d([{ message: t.welcomeMessage ?? Kr, type: "apiMessage" }]),
                r && (r.disconnect(), g(""));
            }
          );
        }),
                ...
                C(
                  (() => {
                    ...
                    return () => {
                      return (
                        t() &&
                        ((r = Xr()).style.setProperty("display", "flex"),
  ...
  Zr = (t) => {
    return (
      (e = Jr()), "function" == typeof (r = t.ref) ? lt(r, e) : (t.ref = e), e
    );
    var e, r;
  },
  ts = st("<style>"),
  ...
  is = (t) => {
    var e = t.id
      ...
      : document.querySelector("eflowai-fullchatbot");
    if (!e) throw new Error("<eflowai-fullchatbot> element not found.");
    Object.assign(e, t);
  },
  as = (t) => {
    var e = document.createElement("eflowai-chatbot");
    Object.assign(e, t), document.body.appendChild(e);
  },
  ls =
    ("undefined" != typeof window &&
      (mt("eflowai-fullchatbot", wt, os), mt("eflowai-chatbot", wt, rs)),
    { initFull: is, init: as });
((t) => {
